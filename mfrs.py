...
class MF(object):
    ...
    def normalize_Y(self):
        ...
        # if we want to normalzie based on item
        else:
            user_col = 1
            item_col = 0
        ...
        for n in range(n_objects):
            ...
            # since indices need to be integers,
    ...
    def get_items_rated_by_user(self, user_id):
        ...
        item_ids = self.Y_data_n[ids, 1].astype(np.int32) # indices need to be integer
        ratings = self.Y_data_n[ids, 2]
    ...
    def updateW(self):
        for n in range(self.n_users):
            ...
            self.W[:, n] -= self.learning_rate*grad_wm.reshape((self.K,))
